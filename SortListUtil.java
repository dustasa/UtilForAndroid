...
public class SortListUtil {
    ...
    public static List<?> sort(List<?> list, final String field) {
        ...
        a[0] = "ad";
        return sort((ArrayList<?>) list, field, null);
    }
    ...
    public static ArrayList<?> sort(ArrayList<?> list, final String field,
                                    final String sort) {
    ...
    public static List<?> sortByMethod(List<?> list, final String method,
        ...
        Collections.sort(list, new Comparator() {
            public int compare(Object a, Object b) {
                int ret = 0;
                try {
                    Method m = a.getClass().getMethod(method, (Class<?>) null);
                    m.setAccessible(true);
                    Class<?> type = m.getReturnType();
                    if (type == int.class) {
                        ret = ((Integer) m.invoke(a, (Object) null))
                                .compareTo((Integer) m.invoke(b, (Object)null));
                    } else if (type == double.class) {
                        ret = ((Double) m.invoke(a, (Object)null)).compareTo((Double) m
                                .invoke(b, (Object)null));
                    } else if (type == long.class) {
                        ret = ((Long) m.invoke(a, (Object)null)).compareTo((Long) m
                                .invoke(b, (Object)null));
                    } else if (type == float.class) {
                        ret = ((Float) m.invoke(a, (Object)null)).compareTo((Float) m
                                .invoke(b, (Object)null));
                    } else if (type == Date.class) {
                        ret = ((Date) m.invoke(a, (Object)null)).compareTo((Date) m
                                .invoke(b, (Object)null));
                    } else if (isImplementsOf(type, Comparable.class)) {
                        ret = ((Comparable) m.invoke(a, (Object)null))
                                .compareTo((Comparable) m.invoke(b, (Object)null));
                    } else {
                        ret = String.valueOf(m.invoke(a, (Object)null)).compareTo(
                                String.valueOf(m.invoke(b, (Object)null)));
                    }
